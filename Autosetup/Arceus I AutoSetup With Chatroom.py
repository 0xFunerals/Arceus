...
if chatroom == "y" or "Y":
    ...
    time.sleep(1)
    Arceus("clear")
    print(""+ red +"5"+ white +".. "+ red +"4"+ white +"..")
    time.sleep(1)
    Arceus("clear")
    print(""+ red +"5"+ white +".. "+ red +"4"+ white +".. "+ red +"3"+ white +"..")
    time.sleep(1)
    Arceus("clear")
    print(""+ red +"5"+ white +".. "+ red +"4"+ white +".. "+ red +"3"+ white +".. "+ red +"2"+ white +"..")
    time.sleep(1)
    Arceus("clear")
    print(""+ red +"5"+ white +".. "+ red +"4"+ white +".. "+ red +"3"+ white +".. "+ red +"2"+ white +".. "+ red +"1"+ white +"..")
    time.sleep(1)
    Arceus("clear")
